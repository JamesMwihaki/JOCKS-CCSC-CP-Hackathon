...
export class Tables1740280612222 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`INSERT INTO buildings (id, buildings_locations, departments, description, image) VALUES (7, 'Dobson Hall', ARRAY[''], 'Dobson Hall contains an art studio, and the offices of Information Technology.', '')`)
